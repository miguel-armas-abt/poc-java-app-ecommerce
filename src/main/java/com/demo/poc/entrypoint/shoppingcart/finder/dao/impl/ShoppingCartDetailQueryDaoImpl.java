...
@Slf4j
public class ShoppingCartDetailQueryDaoImpl implements ShoppingCartDetailQueryDao {

  @Override
  public List<ShoppingCartDetailEntity> findByShoppingCardId(Long shoppingCartId) {
